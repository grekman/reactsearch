...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mvcList = __webpack_require__(220);
	
	var _mvcList2 = _interopRequireDefault(_mvcList);
	
	var _articlesList = __webpack_require__(221);
	
	var _articlesList2 = _interopRequireDefault(_articlesList);
	
	var _movieList = __webpack_require__(248);
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(_reactRouter.IndexRoute, { component: _mvcList2.default })
	            )
	        ),
	        _react2.default.createElement(
	            _reactRouter.Route,
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                _reactRouter.Route,
	                { component: _searchLayout2.default },
	                _react2.default.createElement(_reactRouter.IndexRoute, { component: _movieList2.default })
	            )
	        )
	    )
	);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MvcList = function (_Component) {
	  _inherits(MvcList, _Component);
	  ...
	  function MvcList() {
	    ...
	    _classCallCheck(this, MvcList);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MvcList.__proto__ || Object.getPrototypeOf(MvcList)).call.apply(_ref, [this].concat(args))), _this), _this.state = { searchString: '' }, _this.handleChange = function (e) {
	      _this.setState({
	  ...
	  _createClass(MvcList, [{
	    key: 'render',
	    value: function render() {
	      // console.log(this.state.searchString);
	      var mainLibrary = void 0;
	      var newAllMvc = allMvc;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text', value: this.state.searchString, onChange: this.handleChange, className: 'input-field', placeholder: 'Type at least first two letters' }),
	        mainLibrary
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ArticlesList = function (_Component) {
	  _inherits(ArticlesList, _Component);
	  ...
	  function ArticlesList() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ArticlesList.__proto__ || Object.getPrototypeOf(ArticlesList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      posts: [],
	      loading: true,
	      error: null
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  ...
	  _createClass(ArticlesList, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get('https://www.reddit.com/r/reactjs.json').then(function (res) {
	        // console.log(res);
	        _this2.setState({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MovieList = function (_Component) {
	  ...
	  function MovieList() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MovieList.__proto__ || Object.getPrototypeOf(MovieList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      posts: [],
	      loading: true,
	      error: null
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  ...
	  _createClass(MovieList, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get('https://api.themoviedb.org/3/discover/movie?api_key=2cdce3bbe05c745f380ca0af5874a2d8&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1').then(function (res) {
	        // console.log(res);
	        _this2.setState({
	    ...
	    value: function renderPosts() {
	      ...
	      return _react2.default.createElement(
	        ...
	        posts.map(function (post) {
	          return _react2.default.createElement(
	            'li',
	            { key: post.id, className: 'movie-wraper' },
	            _react2.default.createElement(
	              'div',
	              { className: 'poster' },
	              _react2.default.createElement('img', { src: 'https://image.tmdb.org/t/p/w185_and_h278_bestv2/' + post.poster_path })
	            ),
	            _react2.default.createElement(
	              'div',
